...
from monai.inferers.SaliencyInferer import SaliencyInferer

__all__ = ["sliding_saliency_inference"]

def sliding_saliency_inference(
    inputs: torch.Tensor,
    ...
    **kwargs: Any,
    ...
    for slice_g in range(0, total_slices, sw_batch_size):
        ...
        seg_prob = predictor(window_data,model).to(device)  # batched patch segmentation
